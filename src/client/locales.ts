...
export const zh = {
  ...
  'empty': '暂无用量记录。运行几次对话后，这里会按「模型 × 小时」展示 token 用量。',
  'totals.title': '累计用量',
  'day.title': '每小时用量',
  'col.date': '日期',
  'col.model': '模型',
  ...
  'metric.activeHours': '个活跃小时',
  'metric.models': '使用模型',
  'metric.modelsDetail': '已记录模型数',
  'chart.tokens': 'Tokens 用量（按小时）',
  'chart.calls': '请求次数（按小时）',
  'chart.hourly': '按小时聚合',
  'models.title': '模型明细',
...
export const en = {
  ...
  'empty': 'No usage recorded yet. Run a few conversations and per-model hourly token usage will show up here.',
  'totals.title': 'Cumulative usage',
  'day.title': 'Hourly usage',
  'col.date': 'Date',
  'col.model': 'Model',
  'col.calls': 'Calls',
  ...
  'metric.activeHours': 'active hours',
  'metric.models': 'Models used',
  'metric.modelsDetail': 'recorded models',
  'chart.tokens': 'Token usage (hourly)',
  'chart.calls': 'Requests (hourly)',
  'chart.hourly': 'Hourly aggregate',
